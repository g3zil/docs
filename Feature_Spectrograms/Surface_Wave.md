...
The digital_RF data from WW0WWV/0 can be post processed to examine the PSWS measured frequency with sub-milliHz resolution. Having the control station at WW0WWV/0 means that we can see two artifacts due to the GPSDO. Both can be seen in the plot below:
...
* Periodic variation -
  ...
  <img width="1674" height="551" alt="WW0WWV_offsets_25MHz" src="https://github.com/user-attachments/assets/09c3d1fb-47b6-40af-bbb5-70d9d4de77f3" />
